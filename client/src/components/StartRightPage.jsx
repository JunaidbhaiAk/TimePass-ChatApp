...
const StartRightPage = () => {
    return (
        <Box display="flex" flexDirection="column" width="60%" alignItems="center" justifyContent="center" backgroundColor="#9fb1bcff" borderBottomRightRadius="10px" borderTopRightRadius="10px">
